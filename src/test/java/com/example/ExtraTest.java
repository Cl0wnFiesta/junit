...
import com.example.laskin.Laskin;
...
public class ExtraTest extends AbstractParent {
    ...
    public void testNelio2() {
        laskin.nelio(2);
        assertEquals(4, laskin.annaTulos(), "Luvun 2 Neliään korotus väärin");
    }

    @Test
    public void testNelio4() {
        laskin.nelio(4);
        assertEquals(16, laskin.annaTulos(),"Luvun 4 neliään korotus väärin");
    }

    @Test
    public void testNelio5() {
        laskin.nelio(5);
        assertEquals(25, laskin.annaTulos(), DELTA,"Luvun 5 neliään korotus väärin");
    }
    @Test
    ...
    @Test
    @DisplayName("Testaa negatiivinen neliäjuuri")
